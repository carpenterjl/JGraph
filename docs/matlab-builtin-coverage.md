...
Across every callable kind — builtin, function, operator, keyword, script — the count is **1,113 of
2,024** as of M132. The fifty-nine names since M126 came in one wave and one milestone after it: the
