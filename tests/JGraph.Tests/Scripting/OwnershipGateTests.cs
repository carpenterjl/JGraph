...
public class OwnershipGateTests
{
    ...
    [
        ...
        ("Interpreter.cs",
         ...
         "a persistent slot bound into the frame: one binding by design, which V5 (M9) makes exact"),
        ("Interpreter.cs",
        ...
        ("Interpreter.cs",
         ...
         "a table column read out into a scratch slot, rebuilt by the write and put back"),
        ("Interpreter.cs",
