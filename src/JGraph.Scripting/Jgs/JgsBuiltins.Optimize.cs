...
internal static partial class JgsBuiltins
{
    ...
    internal static void RegisterOptimizeBuiltins(JgsEnvironment env, JGraphScriptGlobals host)
    {
        ...
        env.Builtins.Register("optimset", JgsValue.Function(new BuiltinFunction(
        ...
        env.Builtins.Register("optimget", JgsValue.Function(new BuiltinFunction("optimget", Optimget)));
