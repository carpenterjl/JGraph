...
public static class JgsBuiltinCatalog
{
    ...
    private static IReadOnlyDictionary<string, JgsBuiltinInfo> Build()
    {
        ...
        Add("ode45", "Solves dy/dt = f(t, y): [t, y] = ode45(f, tspan, y0, options), Dormand-Prince with adaptive steps; [t, y, te, ye, ie] with Events; one output answers a solution structure instead.", P("f"), P("tspan"), P("y0"), Opt("options"));
        Add("ode23", "Solves dy/dt = f(t, y) with the Bogacki-Shampine 2(3) pair, the same forms as ode45: [t, y] = ode23(f, tspan, y0, options).", P("f"), P("tspan"), P("y0"), Opt("options"));
        ...
        Add("odeprint", "An output function printing t and y at every step: odeset('OutputFcn', @odeprint).", P("t"), P("y"), Opt("flag"));
        ...
        Add("bartlett", "A Bartlett (triangular) window of n points that reaches zero at both ends.", P("n"));
        Add("bohmanwin", "A Bohman window of n points: the convolution of two half-cycle cosine lobes.", P("n"));
        Add("boxcar", "A rectangular window of n points; the old name for rectwin.", P("n"));
        Add("parzenwin", "A Parzen (de la Vallee-Poussin) window of n points.", P("n"));
        Add("rectwin", "A rectangular window of n points: every coefficient is one.", P("n"));
        Add("triang", "A triangular window of n points whose ends stop one step short of zero.", P("n"));
        Add("blackman", "A Blackman window: blackman(n) and blackman(n, 'symmetric'|'periodic').", P("n"), Opt("sflag"));
        Add("blackmanharris", "A minimum four-term Blackman-Harris window: blackmanharris(n, sflag).", P("n"), Opt("sflag"));
        Add("flattopwin", "A flat-top window, which trades resolution for amplitude accuracy: flattopwin(n, sflag).", P("n"), Opt("sflag"));
        Add("hamming", "A Hamming window: hamming(n) and hamming(n, 'symmetric'|'periodic').", P("n"), Opt("sflag"));
        Add("hann", "A Hann (raised cosine) window: hann(n) and hann(n, 'symmetric'|'periodic').", P("n"), Opt("sflag"));
        Add("hanning", "A Hann window without its zero endpoints, which is not hann: hanning(n, sflag).", P("n"), Opt("sflag"));
        Add("nuttallwin", "A minimum four-term Nuttall window: nuttallwin(n, sflag).", P("n"), Opt("sflag"));
        Add("kaiser", "A Kaiser window of n points shaped by beta (0.5 by default).", P("n"), Opt("beta"));
        Add("chebwin", "A Dolph-Chebyshev window whose side-lobes are all r decibels down (100 by default).", P("n"), Opt("r"));
        Add("gausswin", "A Gaussian window of n points, alpha reciprocal standard deviations wide (2.5 by default).", P("n"), Opt("alpha"));
        Add("tukeywin", "A tapered cosine window: a flat top with cosine tapers over a fraction r of it.", P("n"), Opt("r"));
        Add("taylorwin", "A Taylor window: taylorwin(n, nbar, sll) with nbar equal side-lobes at sll decibels.", P("n"), Opt("nbar"), Opt("sll"));
        Add("dpss", "The discrete prolate spheroidal (Slepian) sequences: [e, v] = dpss(n, nw, k).", P("n"), P("nw"), Opt("k"), Opt("method"), Opt("ni"), Opt("trace"));
        Add("window", "Any window by handle or name: window(@hamming, n) and window(@taylorwin, n, 5, -35).", P("wname"), P("n"), Opt("opt1"), Opt("opt2"));
        Add("sinc", "The normalized sinc, sin(pi x) over pi x, which is one at the origin.", P("x"));
        Add("diric", "The Dirichlet or periodic sinc kernel of order n.", P("x"), P("n"));
        Add("sawtooth", "A sawtooth wave of period 2*pi, rising over a fraction width of each cycle.", P("t"), Opt("width"));
        Add("square", "A square wave of period 2*pi with a duty cycle in per cent (50 by default).", P("t"), Opt("duty"));
        Add("rectpuls", "A rectangular pulse of width w centred on the origin: rectpuls(t, w).", P("t"), Opt("w"));
        Add("tripuls", "A triangular pulse of width w skewed by s: tripuls(t, w, s).", P("t"), Opt("w"), Opt("s"));
        Add("gauspuls", "A Gaussian-modulated sinusoid: [yi, yq, ye] = gauspuls(t, fc, bw, bwr), or gauspuls('cutoff', ...).", P("t"), Opt("fc"), Opt("bw"), Opt("bwr"), Opt("tpr"));
        Add("gmonopuls", "A Gaussian monopulse: gmonopuls(t, fc), or gmonopuls('cutoff', fc) for its duration.", P("t"), Opt("fc"));
        Add("chirp", "A swept-frequency cosine: chirp(t, f0, t1, f1, method, phi) with 'linear', 'quadratic' or 'logarithmic'.", P("t"), Opt("f0"), Opt("t1"), Opt("f1"), Opt("method"), Opt("phi"), Opt("shape"));
        Add("pulstran", "A pulse train: pulstran(t, d, 'func', ...) or pulstran(t, d, p, fs, method) from a sampled prototype.", P("t"), P("d"), P("func"), Opt("p1"), Opt("p2"), Opt("p3"));
        Add("vco", "A voltage-controlled oscillator: vco(x, fc, fs) or vco(x, [fmin fmax], fs).", P("x"), Opt("range"), Opt("fs"));
        Add("hilbert", "The analytic signal, whose imaginary part is the Hilbert transform: hilbert(x, n).", P("x"), Opt("n"));
        Add("czt", "The chirp z-transform: m points along the spiral starting at a and stepping by w.", P("x"), Opt("m"), Opt("w"), Opt("a"));
        Add("goertzel", "The transform at named bins by Goertzel's recurrence: goertzel(x, indices, dim).", P("x"), Opt("indices"), Opt("dim"));
        Add("fwht", "The fast Walsh-Hadamard transform: fwht(x, n, 'sequency'|'hadamard'|'dyadic').", P("x"), Opt("n"), Opt("ordering"));
        Add("ifwht", "The inverse fast Walsh-Hadamard transform: ifwht(x, n, ordering).", P("x"), Opt("n"), Opt("ordering"));
        Add("cceps", "The complex cepstrum, with the linear phase it removed: [xhat, nd] = cceps(x, n).", P("x"), Opt("n"));
        Add("icceps", "The signal a complex cepstrum came from, with its delay put back: icceps(xhat, nd).", P("xhat"), Opt("nd"));
        Add("rceps", "The real cepstrum and the minimum-phase signal that shares it: [xhat, yhat] = rceps(x).", P("x"));
        Add("dftmtx", "The n-by-n discrete Fourier transform matrix.", P("n"));
        Add("bitrevorder", "The rows put in bit-reversed order: [y, i] = bitrevorder(x).", P("x"));
        Add("digitrevorder", "The rows put in digit-reversed order for a radix: [y, i] = digitrevorder(x, r).", P("x"), P("r"));
        Add("db2mag", "Decibels to an amplitude ratio.", P("ydb"));
        Add("db2pow", "Decibels to a power ratio.", P("ydb"));
        Add("mag2db", "An amplitude ratio to decibels; a negative amplitude has none.", P("y"));
        Add("pow2db", "A power ratio to decibels.", P("y"));
        Add("buffer", "Cuts a signal into frames: buffer(x, n, p, opt), with [y, z] and [y, z, opt] for streaming.", P("x"), P("n"), Opt("p"), Opt("opt"));
        Add("datawrap", "Adds a signal to itself every nfft samples, which aliases its spectrum to that many bins.", P("x"), P("nfft"));
        Add("seqperiod", "The shortest prefix that repeats through the rest: [p, n] = seqperiod(x, tol).", P("x"), Opt("tol"));
        Add("shiftdata", "Brings a dimension to the front and remembers how: [x, perm, nshifts] = shiftdata(x, dim).", P("x"), Opt("dim"));
        Add("unshiftdata", "Puts back what shiftdata moved: y = unshiftdata(x, perm, nshifts).", P("x"), P("perm"), P("nshifts"));
        Add("uencode", "Quantises to n bits over plus or minus v: uencode(u, n, v, 'signed'|'unsigned').", P("u"), P("n"), Opt("v"), Opt("signflag"));
        Add("udecode", "Recovers samples from their n-bit codes: udecode(u, n, v, 'saturate'|'wrap').", P("u"), P("n"), Opt("v"), Opt("overflow"));
        Add("marcumq", "Marcum's generalised Q function of order m: marcumq(a, b, m).", P("a"), P("b"), Opt("m"));
        Add("modulate", "Puts a message onto a carrier: [y, t] = modulate(x, fc, fs, method, opt), nine methods.", P("x"), P("fc"), P("fs"), Opt("method"), Opt("opt"));
        Add("demod", "Takes a message off a carrier: demod(y, fc, fs, method, opt), and [x1, x2] for 'qam'.", P("y"), P("fc"), P("fs"), Opt("method"), Opt("opt"));
        Add("framesig", "Frames a signal with a window and an overlap: [xw, fc, fi] = framesig(x, fl, Name=Value).", P("x"), P("fl"), Opt("name"), Opt("value"));

        // --- Signal Processing Toolbox: filtering, conversions, multirate (M133) -----------------
        Add("filtfilt", "Zero-phase filtering: filtfilt(b, a, x), filtfilt(sos, g, x) and the cascaded form.", P("b"), P("a"), P("x"), Opt("ctf"));
        Add("sosfilt", "Runs a cascade of second-order sections down each column: sosfilt(sos, x, dim).", P("sos"), P("x"), Opt("dim"));
        Add("fftfilt", "Overlap-add FIR filtering through the transform: fftfilt(b, x, n).", P("b"), P("x"), Opt("n"));
        Add("filtic", "The delay line that makes a filter start from a given past: filtic(b, a, y, x).", P("b"), P("a"), P("y"), Opt("x"));
        Add("latcfilt", "Lattice and lattice-ladder filtering: [f, g, zf] = latcfilt(k, v, x, 'ic', zi, dim).", P("k"), P("x"), Opt("arg3"), Opt("arg4"), Opt("arg5"), Opt("dim"));
        Add("medfilt1", "The running median: medfilt1(x, n, blksz, dim, 'zeropad'|'truncate', 'includenan'|'omitnan').", P("x"), Opt("n"), Opt("blksz"), Opt("dim"), Opt("padding"), Opt("missing"));
        Add("hampel", "Replaces outliers by the local median: [y, i, xmedian, xsigma] = hampel(x, k, nsigma).", P("x"), Opt("k"), Opt("nsigma"));
        Add("sgolay", "Savitzky-Golay design: [b, g] = sgolay(order, framelen, weights).", P("order"), P("framelen"), Opt("weights"));
        Add("sgolayfilt", "Savitzky-Golay filtering: sgolayfilt(x, order, framelen, weights, dim).", P("x"), P("order"), P("framelen"), Opt("weights"), Opt("dim"));
        Add("filtstates", "Filter-state values: filtstates.dfiir(num, den) and filtstates.cic(int, comb).", Opt("a"), Opt("b"));
        Add("tf2zp", "Transfer function to zeros, poles and gain: [z, p, k] = tf2zp(num, den).", P("num"), P("den"));
        Add("tf2zpk", "The same after both sides are padded to a common length: [z, p, k] = tf2zpk(b, a).", P("b"), Opt("a"));
        Add("zp2tf", "Zeros, poles and gain back to a transfer function: [num, den] = zp2tf(z, p, k).", P("z"), P("p"), P("k"));
        Add("tf2ss", "Transfer function to the controllable canonical form: [a, b, c, d] = tf2ss(num, den).", P("num"), P("den"));
        Add("ss2tf", "State space to a transfer function: [num, den] = ss2tf(a, b, c, d, iu).", P("a"), P("b"), P("c"), P("d"), Opt("iu"));
        Add("ss2zp", "State space to zeros, poles and gain: [z, p, k] = ss2zp(a, b, c, d, iu).", P("a"), P("b"), P("c"), P("d"), Opt("iu"));
        Add("zp2ss", "Zeros, poles and gain to balanced second-order blocks: [a, b, c, d] = zp2ss(z, p, k).", P("z"), P("p"), P("k"));
        Add("eqtflength", "Pads a numerator and denominator to a common length: [b, a, n, m] = eqtflength(num, den).", P("num"), P("den"));
        Add("polystab", "Reflects every root outside the unit circle to its reciprocal conjugate.", P("a"));
        Add("polyscale", "Pulls a polynomial roots towards the origin: polyscale(a, scale).", P("a"), P("scale"));
        Add("residuez", "Partial fractions in powers of z inverse: [r, p, k] = residuez(b, a) and its inverse.", P("b"), P("a"), Opt("k"));
        Add("zp2sos", "Roots to second-order sections: [sos, g] = zp2sos(z, p, k, dir, scale, krz).", P("z"), P("p"), Opt("k"), Opt("dir"), Opt("scale"), Opt("krz"));
        Add("tf2sos", "Transfer function to second-order sections: [sos, g] = tf2sos(b, a, dir, scale).", P("b"), P("a"), Opt("dir"), Opt("scale"));
        Add("ss2sos", "State space to second-order sections: [sos, g] = ss2sos(a, b, c, d, iu, dir, scale).", P("a"), P("b"), P("c"), P("d"), Opt("iu"), Opt("dir"), Opt("scale"));
        Add("sos2zp", "Second-order sections to roots: [z, p, k] = sos2zp(sos, g).", P("sos"), Opt("g"));
        Add("sos2tf", "Second-order sections to a transfer function: [b, a] = sos2tf(sos, g).", P("sos"), Opt("g"));
        Add("sos2ss", "Second-order sections to state space: [a, b, c, d] = sos2ss(sos, g).", P("sos"), Opt("g"));
        Add("sos2ctf", "Second-order sections split into numerators and denominators: [b, a] = sos2ctf(sos, g).", P("sos"), Opt("g"));
        Add("zp2ctf", "Roots to a cascaded transfer function: [num, den, g] = zp2ctf(z, p, k, SectionOrder=, Direction=, Scale=).", P("z"), P("p"), Opt("k"), Opt("name"), Opt("value"));
        Add("sos2cell", "Second-order sections as a cell array of coefficient pairs: sos2cell(s, g).", P("s"), Opt("g"));
        Add("cell2sos", "A cell array of coefficient pairs back to a section matrix: [s, g] = cell2sos(c).", P("c"));
        Add("scaleFilterSections", "Folds a cascade scale values into its numerators: scaleFilterSections(ctfNum, sv).", P("ctfNum"), P("sv"));
        Add("tf2latc", "Transfer function to lattice and ladder coefficients: [k, v] = tf2latc(num, den, phase).", P("num"), Opt("den"), Opt("phase"));
        Add("latc2tf", "Lattice back to a transfer function: [num, den] = latc2tf(k, v) and its four word forms.", P("k"), Opt("v"));
        Add("upsample", "One sample in, n out, the rest zero: upsample(x, n, phase).", P("x"), P("n"), Opt("phase"));
        Add("downsample", "Every n-th sample, starting at phase: downsample(x, n, phase).", P("x"), P("n"), Opt("phase"));
        Add("upfirdn", "Upsample, filter and downsample in one polyphase pass: upfirdn(x, h, p, q).", P("x"), P("h"), Opt("p"), Opt("q"));
        Add("interp", "Raises a sample rate by a whole factor: [y, b] = interp(x, r, n, cutoff).", P("x"), P("r"), Opt("n"), Opt("cutoff"));
        Add("decimate", "Lowers a sample rate by a whole factor: decimate(x, r, n, 'fir'|'iir').", P("x"), P("r"), Opt("n"), Opt("option"));
        ...
        // --- Signal Processing Toolbox: spectral estimation (M136) --------------------------------
        Add("periodogram", "The power spectral density of one windowed record: [pxx, f] = periodogram(x, window, nfft, fs).", P("x"), Opt("window"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("pwelch", "Welch's averaged periodogram: [pxx, f] = pwelch(x, window, noverlap, nfft, fs).", P("x"), Opt("window"), Opt("noverlap"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("cpsd", "The cross power spectral density of two signals: [pxy, f] = cpsd(x, y, window, noverlap, nfft, fs).", P("x"), P("y"), Opt("window"), Opt("noverlap"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("mscohere", "The magnitude-squared coherence of two signals: [cxy, f] = mscohere(x, y, window, noverlap, nfft, fs).", P("x"), P("y"), Opt("window"), Opt("noverlap"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("tfestimate", "The transfer function estimate from x to y: [txy, f] = tfestimate(x, y, window, noverlap, nfft, fs).", P("x"), P("y"), Opt("window"), Opt("noverlap"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("psd", "Removed from MATLAB: use periodogram or pwelch.", P("x"), Opt("more"));
        Add("spectrum", "Removed from MATLAB: use periodogram, pwelch, pburg or pcov.", P("x"), Opt("more"));
        Add("csd", "The cross spectral density of 1993: csd(x, y, nfft, fs, window, noverlap, p, dflag).", P("x"), P("y"), Opt("nfft"), Opt("fs"), Opt("window"), Opt("noverlap"), Opt("p"), Opt("dflag"));
        Add("cohere", "The coherence of 1993, argument for argument as csd reads them.", P("x"), P("y"), Opt("nfft"), Opt("fs"), Opt("window"), Opt("noverlap"), Opt("p"), Opt("dflag"));
        Add("tfe", "The transfer function estimate of 1993, argument for argument as csd reads them.", P("x"), P("y"), Opt("nfft"), Opt("fs"), Opt("window"), Opt("noverlap"), Opt("p"), Opt("dflag"));
        Add("specgram", "The short-time transform of 1993: [b, f, t] = specgram(x, nfft, fs, window, noverlap).", P("x"), Opt("nfft"), Opt("fs"), Opt("window"), Opt("noverlap"));
        Add("pburg", "The power spectral density from a Burg autoregressive fit: [pxx, f] = pburg(x, order, nfft, fs).", P("x"), P("order"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("pcov", "The power spectral density from a covariance autoregressive fit.", P("x"), P("order"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("pmcov", "The power spectral density from a modified covariance autoregressive fit.", P("x"), P("order"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("pyulear", "The power spectral density from a Yule-Walker autoregressive fit.", P("x"), P("order"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("pmusic", "The MUSIC pseudospectrum: [s, f] = pmusic(x, p, nfft, fs, nwin, noverlap).", P("x"), P("p"), Opt("nfft"), Opt("fs"), Opt("nwin"), Opt("noverlap"), Opt("option"));
        Add("peig", "The eigenvector pseudospectrum, which is pmusic weighted by its eigenvalues.", P("x"), P("p"), Opt("nfft"), Opt("fs"), Opt("nwin"), Opt("noverlap"), Opt("option"));
        Add("rootmusic", "The frequencies and powers MUSIC finds by rooting: [w, pow] = rootmusic(x, p, fs).", P("x"), P("p"), Opt("fs"), Opt("option"));
        Add("rooteig", "The frequencies and powers the eigenvector method finds by rooting.", P("x"), P("p"), Opt("fs"), Opt("option"));
        Add("corrmtx", "A data matrix whose Gram matrix is a correlation estimate: [X, R] = corrmtx(x, m, method).", P("x"), P("m"), Opt("method"));
        Add("pmem", "The maximum-entropy power spectrum: [pxx, f, a] = pmem(x, p, nfft, fs).", P("x"), P("p"), Opt("nfft"), Opt("fs"), Opt("flag"));
        Add("pmtm", "Thomson's multitaper power spectral density: [pxx, f] = pmtm(x, nw, nfft, fs).", P("x"), Opt("nw"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("plomb", "The Lomb-Scargle periodogram of an unevenly sampled signal: [pxx, f] = plomb(x, t, f, ofac).", P("x"), Opt("t"), Opt("f"), Opt("ofac"), Opt("option"));
        Add("enbw", "A window's equivalent noise bandwidth: bw = enbw(window, fs).", P("window"), Opt("fs"));
        Add("bandpower", "The average power in a band: bandpower(x), bandpower(x, fs, range) or bandpower(pxx, f, range, 'psd').", P("x"), Opt("fs"), Opt("range"), Opt("flag"));
        Add("meanfreq", "The mean frequency of a spectrum: [f, p] = meanfreq(x, fs, range).", P("x"), Opt("fs"), Opt("range"), Opt("flag"));
        Add("medfreq", "The median frequency of a spectrum: [f, p] = medfreq(x, fs, range).", P("x"), Opt("fs"), Opt("range"), Opt("flag"));
        Add("obw", "The occupied bandwidth: [bw, flo, fhi, pwr] = obw(x, fs, range, p).", P("x"), Opt("fs"), Opt("range"), Opt("p"));
        Add("powerbw", "The power bandwidth: [bw, flo, fhi, pwr] = powerbw(x, fs, range, r).", P("x"), Opt("fs"), Opt("range"), Opt("r"));
        Add("thd", "Total harmonic distortion in decibels: [r, harmpow, harmfreq] = thd(x, fs, n).", P("x"), Opt("fs"), Opt("n"), Opt("flag"));
        Add("snr", "Signal-to-noise ratio in decibels: snr(x, fs, n), snr(x, y) or snr(pxx, f, 'psd').", P("x"), Opt("fs"), Opt("n"), Opt("flag"));
        Add("sinad", "Signal to noise and distortion ratio in decibels: [r, noisepow] = sinad(x, fs).", P("x"), Opt("fs"), Opt("flag"));
        Add("sfdr", "Spurious free dynamic range: [r, spurpow, spurfreq] = sfdr(x, fs, msd).", P("x"), Opt("fs"), Opt("msd"), Opt("flag"));
        Add("toi", "Third-order intercept: [oip3, fundpow, fundfreq, imodpow, imodfreq] = toi(x, fs).", P("x"), Opt("fs"), Opt("flag"));
        Add("findpeaks", "Local maxima with their locations, widths and prominences: [pks, locs, w, p] = findpeaks(y, x, 'MinPeakHeight', h).", P("y"), Opt("x"), Opt("name"), Opt("value"));
        Add("peak2peak", "The distance from the largest to the smallest value: peak2peak(x, dim).", P("x"), Opt("dim"));
        Add("peak2rms", "The largest magnitude over the root mean square: peak2rms(x, dim).", P("x"), Opt("dim"));
        Add("rssq", "The root sum of squares: rssq(x, dim).", P("x"), Opt("dim"));
        Add("zerocrossrate", "How often a signal crosses a level: [rate, count] = zerocrossrate(x, 'Level', l).", P("x"), Opt("name"), Opt("value"));
        Add("statelevels", "The two states of a bilevel waveform: [levels, hist, bins] = statelevels(x, nbins, method).", P("x"), Opt("nbins"), Opt("method"), Opt("bounds"));
        Add("midcross", "Where a waveform crosses its mid reference level: [c, midlev] = midcross(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("risetime", "How long each rising transition takes: [r, lo, hi] = risetime(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("falltime", "How long each falling transition takes: [f, lo, hi] = falltime(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("slewrate", "The slope of each transition: [s, lo, hi] = slewrate(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("pulsewidth", "The width of each pulse: [w, init, final] = pulsewidth(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("pulseperiod", "The period of each pulse: [p, init, final, next] = pulseperiod(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("pulsesep", "The gap between pulses: [s, init, final, next] = pulsesep(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("dutycycle", "The duty cycle of each pulse, or tau times prf: d = dutycycle(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("overshoot", "How far each transition goes past its final state: [os, lev, inst] = overshoot(x, fs).", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("undershoot", "How far each transition falls short of its final state.", P("x"), Opt("fs"), Opt("name"), Opt("value"));
        Add("settlingtime", "How long each transition takes to settle: [s, lev, inst] = settlingtime(x, fs, d).", P("x"), Opt("fs"), P("d"), Opt("name"), Opt("value"));
        Add("finddelay", "The delay between two signals, in samples: d = finddelay(x, y, maxlag).", P("x"), Opt("y"), Opt("maxlag"));
        Add("alignsignals", "Shifts two signals into alignment: [xa, ya, d] = alignsignals(x, y, maxlag, 'truncate').", P("x"), P("y"), Opt("maxlag"), Opt("option"));
        Add("dtw", "The dynamic time warping distance and path: [d, ix, iy] = dtw(x, y, maxsamp, metric).", P("x"), P("y"), Opt("maxsamp"), Opt("metric"));
        Add("edr", "The edit distance on real signals: [d, ix, iy] = edr(x, y, tol, maxsamp, metric).", P("x"), P("y"), P("tol"), Opt("maxsamp"), Opt("metric"));
        Add("findsignal", "Where a signal best matches inside a longer record: [istart, istop, dist] = findsignal(data, signal).", P("data"), P("signal"), Opt("name"), Opt("value"));
        Add("xcorr2", "The two-dimensional cross-correlation: c = xcorr2(a, b).", P("a"), Opt("b"));
        Add("cconv", "The circular convolution of two vectors: c = cconv(a, b, n).", P("a"), P("b"), Opt("n"));
        Add("convmtx", "The convolution matrix of a vector: A = convmtx(h, n).", P("h"), P("n"));
        Add("cusum", "The cumulative sum control chart: [iupper, ilower, us, ls] = cusum(x, climit, mshift, tmean, tdev).", P("x"), Opt("climit"), Opt("mshift"), Opt("tmean"), Opt("tdev"), Opt("option"));
        Add("findchangepts", "Where a signal's statistics change: [ipt, res] = findchangepts(x, 'MaxNumChanges', k).", P("x"), Opt("name"), Opt("value"));

        // --- Signal Processing Toolbox: time-frequency, modelling, vibration (M137) ---------------
        Add("spectrogram", "The short-time Fourier transform: [s, f, t, p] = spectrogram(x, window, noverlap, nfft, fs).", P("x"), Opt("window"), Opt("noverlap"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("xspectrogram", "The cross spectrogram of two signals: [s, f, t, c] = xspectrogram(x, y, window, noverlap, nfft, fs).", P("x"), P("y"), Opt("window"), Opt("noverlap"), Opt("nfft"), Opt("fs"), Opt("option"));
        Add("stft", "The short-time Fourier transform with named options: [s, f, t] = stft(x, fs, 'Window', w, 'OverlapLength', n).", P("x"), Opt("fs"), Opt("name"), Opt("value"), Opt("more"));
        Add("istft", "The inverse short-time Fourier transform: [x, t] = istft(s, fs, 'Window', w, 'OverlapLength', n).", P("s"), Opt("fs"), Opt("name"), Opt("value"), Opt("more"));
        Add("iscola", "Whether a window and overlap satisfy the constant overlap-add condition: [tf, m, d] = iscola(win, noverlap, method).", P("window"), P("noverlap"), Opt("method"));
        Add("stftmag2sig", "The signal whose short-time transform has given magnitudes: x = stftmag2sig(s, nfft, fs, ...).", P("s"), P("nfft"), Opt("fs"), Opt("name"), Opt("value"), Opt("more"));
        Add("fsst", "The Fourier synchrosqueezed transform: [sst, f, t] = fsst(x, fs, window).", P("x"), Opt("fs"), Opt("window"), Opt("freqloc"));
        Add("ifsst", "The inverse synchrosqueezed transform: x = ifsst(sst, window, iridge).", P("sst"), Opt("window"), Opt("iridge"), Opt("more"), Opt("value"));
        Add("tfridge", "The ridges of a time-frequency map: [fridge, iridge, lridge] = tfridge(tfm, f, penalty, 'NumRidges', n).", P("tfm"), P("f"), Opt("penalty"), Opt("name"), Opt("value"), Opt("more"));
        Add("kurtogram", "The fast kurtogram: [kgram, f, w, fc, wc, bw] = kurtogram(x, fs, level).", P("x"), Opt("fs"), Opt("level"));
        Add("spectralKurtosis", "The kurtosis of a spectrum, or of each frequency across frames: [k, spread, centroid] = spectralKurtosis(x, f).", P("x"), Opt("f"), Opt("name"), Opt("value"), Opt("more"));
        Add("spectralSkewness", "The skewness of a spectrum: [s, spread, centroid] = spectralSkewness(x, f).", P("x"), Opt("f"), Opt("name"), Opt("value"), Opt("more"));
        Add("spectralFlatness", "The geometric mean over the arithmetic one: [fl, a, g] = spectralFlatness(x, f).", P("x"), Opt("f"), Opt("name"), Opt("value"), Opt("more"));
        Add("spectralCrest", "The largest bin over the mean one: [c, peak, mean] = spectralCrest(x, f).", P("x"), Opt("f"), Opt("name"), Opt("value"), Opt("more"));
        Add("spectralEntropy", "The Shannon entropy of a spectrum read as a distribution: [se, t] = spectralEntropy(x, f).", P("x"), Opt("f"), Opt("t"), Opt("name"), Opt("value"), Opt("more"));
        Add("levinson", "The Levinson-Durbin recursion: [a, e, k] = levinson(r, n).", P("r"), Opt("n"));
        Add("rlevinson", "The autocorrelation a prediction polynomial came from: [r, u, k, e] = rlevinson(a, efinal).", P("a"), P("efinal"));
        Add("lpc", "Linear predictive coefficients: [a, e] = lpc(x, n).", P("x"), Opt("n"));
        Add("arburg", "Burg's autoregressive fit: [a, e, k] = arburg(x, p).", P("x"), P("p"));
        Add("aryule", "The Yule-Walker autoregressive fit: [a, e, k] = aryule(x, p).", P("x"), P("p"));
        Add("arcov", "The covariance autoregressive fit: [a, e] = arcov(x, p).", P("x"), P("p"));
        Add("armcov", "The modified covariance autoregressive fit: [a, e] = armcov(x, p).", P("x"), P("p"));
        Add("ac2poly", "The prediction polynomial of an autocorrelation: [a, e] = ac2poly(r).", P("r"));
        Add("ac2rc", "The reflection coefficients of an autocorrelation: [k, r0] = ac2rc(r).", P("r"));
        Add("poly2ac", "The autocorrelation of a prediction polynomial: r = poly2ac(a, efinal).", P("a"), P("efinal"));
        Add("poly2rc", "The reflection coefficients of a prediction polynomial: [k, r0] = poly2rc(a, efinal).", P("a"), Opt("efinal"));
        Add("rc2ac", "The autocorrelation of a set of reflection coefficients: r = rc2ac(k, r0).", P("k"), P("r0"));
        Add("rc2poly", "The prediction polynomial of a set of reflection coefficients: [a, e] = rc2poly(k, r0).", P("k"), Opt("r0"));
        Add("schurrc", "The Schur recursion: [k, e] = schurrc(r).", P("r"));
        Add("is2rc", "Inverse sine parameters to reflection coefficients.", P("isin"));
        Add("rc2is", "Reflection coefficients to inverse sine parameters.", P("k"));
        Add("lar2rc", "Log area ratios to reflection coefficients.", P("g"));
        Add("rc2lar", "Reflection coefficients to log area ratios.", P("k"));
        Add("poly2lsf", "Line spectral frequencies of a prediction polynomial.", P("a"));
        Add("lsf2poly", "The prediction polynomial of a set of line spectral frequencies.", P("lsf"));
        Add("prony", "Prony's rational fit to an impulse response: [b, a] = prony(h, nb, na).", P("h"), P("nb"), P("na"));
        Add("stmcb", "The Steiglitz-McBride iteration: [b, a] = stmcb(h, nb, na, niter, ai).", P("x"), P("nb"), P("na"), Opt("niter"), Opt("ai"), Opt("more"));
        Add("invfreqz", "The discrete filter whose response best matches a given one: [b, a] = invfreqz(h, w, nb, na).", P("h"), P("w"), P("nb"), P("na"), Opt("wt"), Opt("iter"), Opt("tol"), Opt("trace"), Opt("more"));
        Add("invfreqs", "The analogue filter whose response best matches a given one: [b, a] = invfreqs(h, w, nb, na).", P("h"), P("w"), P("nb"), P("na"), Opt("wt"), Opt("iter"), Opt("tol"), Opt("trace"), Opt("more"));
        Add("modalfrf", "The frequency-response functions of a modal test: [frf, f, coh] = modalfrf(x, y, fs, window, noverlap).", P("x"), P("y"), P("fs"), P("window"), Opt("noverlap"), Opt("name"), Opt("value"), Opt("more"));
        Add("modalfit", "The modal parameters of a frequency response: [fn, dr, ms, ofrf] = modalfit(frf, f, fs, mnum).", P("frf"), P("f"), P("fs"), P("mnum"), Opt("name"), Opt("value"), Opt("more"));
        Add("modalsd", "The stabilisation diagram of a modal fit: fn = modalsd(frf, f, fs, 'MaxModes', m).", P("frf"), P("f"), P("fs"), Opt("name"), Opt("value"), Opt("more"));
        Add("rainflow", "The ASTM cycle count of a load history: [c, rm, rmr, rmm, idx] = rainflow(x, fs).", P("x"), Opt("fs"), Opt("ext"));
        Add("envspectrum", "The spectrum of a signal's envelope: [spec, f, env, t] = envspectrum(x, fs).", P("x"), P("fs"), Opt("name"), Opt("value"), Opt("more"));
        Add("tsa", "The time-synchronous average of a signal over a shaft's rotations: [ta, t, p, rpm] = tsa(x, fs, tp).", P("x"), P("fs"), P("tp"), Opt("name"), Opt("value"), Opt("more"));
        Add("strips", "Draws a signal as a stack of equal-length strips: strips(x, sd, fs, scale).", P("x"), Opt("sd"), Opt("fs"), Opt("scale"));
        Add("tachorpm", "The rotation speed a tachometer's pulse train implies: [rpm, t, tp] = tachorpm(x, fs).", P("x"), P("fs"), Opt("name"), Opt("value"), Opt("more"));
        Add("rpmfreqmap", "A frequency-against-speed map of a run-up: [map, f, rpm, t, res] = rpmfreqmap(x, fs, rpm).", P("x"), P("fs"), P("rpm"), Opt("res"), Opt("name"), Opt("value"), Opt("more"));
        Add("rpmordermap", "An order-against-speed map of a run-up: [map, order, rpm, t, res] = rpmordermap(x, fs, rpm).", P("x"), P("fs"), P("rpm"), Opt("res"), Opt("name"), Opt("value"), Opt("more"));
        Add("orderspectrum", "The average order spectrum of a map: [spec, order] = orderspectrum(map, order).", P("x"), P("y"), Opt("z"), Opt("value"));
        Add("ordertrack", "The magnitude of named orders over a run-up: [mag, rpm, t] = ordertrack(map, order, rpm, t, orderlist).", P("x"), P("y"), P("z"), P("orderlist"), Opt("name"), Opt("value"), Opt("more"));
