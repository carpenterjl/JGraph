...
internal static partial class JgsBuiltins
{
    ...
    internal static void RegisterVideoBuiltins(JgsEnvironment env, JGraphScriptGlobals host)
    {
        ...
        env.Builtins.Register(VideoWriterClassName, JgsValue.Function(new BuiltinFunction(VideoWriterClassName,
        ...
        env.Builtins.Register("writeVideo", JgsValue.Function(new BuiltinFunction("writeVideo", (args, line, col) =>
        {
