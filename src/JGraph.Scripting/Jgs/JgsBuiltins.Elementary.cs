...
internal static partial class JgsBuiltins
{
        ...
        JgsEnvironment env, Action<string, Func<IReadOnlyList<JgsValue>, int, int, JgsValue>> Define)
    {
        ...
        void Elementwise(string name, Func<double, bool> test) =>
            Define(name, (args, line, col) => { Arity(name, args, 1, line, col); return MapToBool(name, args[0], test, line, col); });
        ...
        Elementwise("isfinite", double.IsFinite);
        Elementwise("isinf", double.IsInfinity);
        ...
        Predicate("isscalar", static v => v.Type is not (JgsType.Array or JgsType.Cell) || Extent(v) == 1);
    ...
    private static bool IsNumericValue(JgsValue value) =>
        value.Type is JgsType.Number or JgsType.Complex or JgsType.Bool or JgsType.Array;
